...
import com.app.resultviewbd.preference.SharedPrefValues;
import com.google.android.material.card.MaterialCardView;
import com.google.android.material.materialswitch.MaterialSwitch;
import com.pixplicity.sharp.Sharp;

/**
 * Activity presenting user styling options, including Material 3 dynamic primary accent selectors,
 * custom accent palette presets, dark/light theme switching, and AMOLED background switches.
 */
public class StyleSettingsActivity extends BaseActivity {
  ...
  /**
   * Binds component views, registers close operations, and boots standard configuration listener
   * panels.
   *
  ...
  /** Installs click-listeners on every color circle representing preset accents. */
  ...
  /**
   * Writes the selected accent theme code to local cache and schedules an immediate activity
   * recreate cycle.
   *
   * @param value String value mapping the target accent selection index.
   */
  ...
  /** Configures click listeners for System, Light, and Dark mode selector labels. */
  ...
  /** Binds toggle change listener callbacks to set amoled black backgrounds on dark theme. */
  ...
  /**
   * Re-evaluates local system themes and fires clean UI recreation triggers on the main thread
   * safely.
   */
  ...
  /**
   * Resolves currently active styling combinations, updates background canvas colors, injects SVG
   * vector previews dynamically using custom replaces, and adjusts badge labels.
   */
      ...
      try {
        ...
        String svg =
            "<svg width=\"100%\" height=\"100%\" viewBox=\"0 0 888 678\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n"
                ...
                + "<path id=\"sco40\" d=\"M64.0829 669.778C64.0829 669.778 64.7046 656.751 77.4493 658.266Z\" fill=\"s40\"/>\n"
  ...
  /**
   * Retrieves correct dynamic or static preview color depending on current style configurations.
   *
   * @param currentAccent The active accent theme configuration code.
   * @return The color resource value.
   */
  ...
  /**
   * Computes primary theme-container badge backing background color references.
   *
   * @param currentAccent The active accent theme configuration code.
   * @return Resolved dynamic or static background color resource.
   */
  ...
  /**
   * Translates style names directly to attribute identifier integers.
   *
   * @param attrName Attribute parameter tag.
   * @return Translated hex code string of corresponding theme color.
   */
  ...
  /**
   * Helper utility method to read attributes and format them as readable hexadecimal strings.
   *
   * @param attribute Target style attribute ID.
   * @return Formatted color code string (e.g., #FFFFFF).
   */
  ...
  /**
   * Accesses host dynamic system theme structure and resolves target attribute values.
   *
   * @param attribute Core layout reference attribute.
