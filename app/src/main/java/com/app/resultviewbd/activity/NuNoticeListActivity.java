...
public class NuNoticeListActivity extends BaseActivity {
   ...
   * handling National University notice options, and loads notices.
   *
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (getSupportActionBar() != null) {
      ...
      getSupportActionBar().setTitle(R.string.item_notice_board);
    }
              ...
              if (item instanceof ItemModel) {
                ...
                */
                ...
                WebViewUtil.openLink(
                    this,
                    JsonNameTranslator.translateNameFromJson(this, model.getTitle()),
                    model.getUrl());
              }
            });
  ...
  /** Fetches the dynamic list of National University notices from remote config JSON. */
        ...
        new RemoteConfigDataManager.OnDataLoadedListener() {
          ...
          public void onDataLoaded(JSONObject configJson) {
            try {
              ...
              remoteConfigDataManager.addArrayItems(
                  configJson, "national_university_notice", boardList);
